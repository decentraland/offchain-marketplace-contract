...
contract MockExternalCallTargetWithMANAClaim {
    CreditsManagerPolygonWithMANAClaimHarness public creditsManager;
    IERC20 public mana;
    uint256 public amount;
    address public beneficiary;
    uint256 public beneficiaryCut;

    constructor(CreditsManagerPolygonWithMANAClaimHarness _creditsManager, IERC20 _mana, uint256 _amount) {
